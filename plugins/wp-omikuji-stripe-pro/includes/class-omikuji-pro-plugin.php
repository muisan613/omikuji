...
class Plugin {
  ...
  public function shortcode_draw($a=[]){ ob_start(); include OMIKUJI_PRO_DIR.'templates/omikuji-button.php'; return ob_get_clean(); }
  public function shortcode_result($a=[]){ ob_start(); include OMIKUJI_PRO_DIR.'templates/omikuji-result.php'; return ob_get_clean(); }
}
