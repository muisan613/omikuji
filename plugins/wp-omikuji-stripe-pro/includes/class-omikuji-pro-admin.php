...
class Admin {
  ...
  public function menu(){ add_options_page('Omikuji Stripe Pro','Omikuji Stripe Pro','manage_options','omikuji-stripe-pro',[ $this,'render' ]); }
  public function settings(){
    ...
    register_setting('omikuji_pro_group','omikuji_pro_webhook_secret');
    register_setting('omikuji_pro_group','omikuji_pro_results_json');
  }
  public function render(){ ?>
  <div class="wrap"><h1>Omikuji Stripe Pro 設定</h1>
    <form method="post" action="options.php">
      ...
      <table class="form-table">
        ...
        <tr><th>価格</th><td><input type="number" name="omikuji_pro_price_amount" value="<?php echo esc_attr(get_option('omikuji_pro_price_amount','200')); ?>" class="small-text"/></td></tr>
        ...
        <tr><th>成功ページ</th><td><?php wp_dropdown_pages(['name'=>'omikuji_pro_success_page_id','selected'=>(int)get_option('omikuji_pro_success_page_id'),'show_option_none'=>'— 選択 —']); ?></td></tr>
        <tr><th>Webhook Secret（任意）</th><td><input type="text" name="omikuji_pro_webhook_secret" value="<?php echo esc_attr(get_option('omikuji_pro_webhook_secret','')); ?>" class="regular-text"/></td></tr>
