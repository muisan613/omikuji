...
class Plugin {
  ...
  public function shortcode_draw($atts=[]){ ob_start(); include OMIKUJI_STRIPE_DIR.'templates/omikuji-button.php'; return ob_get_clean(); }
  public function shortcode_result($atts=[]){ ob_start(); include OMIKUJI_STRIPE_DIR.'templates/omikuji-result.php'; return ob_get_clean(); }
}
