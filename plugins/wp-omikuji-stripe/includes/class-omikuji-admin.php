  ...
  <div class="wrap"><h1>Omikuji Stripe 設定</h1>
    <form method="post" action="options.php">
      ...
      <table class="form-table">
        ...
        <tr><th>成功ページ（[omikuji_result]）</th><td><?php wp_dropdown_pages(['name'=>'omikuji_stripe_success_page_id','selected'=>(int)get_option('omikuji_stripe_success_page_id'),'show_option_none'=>'— 選択 —']); ?></td></tr>
